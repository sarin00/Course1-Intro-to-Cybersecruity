...
7. Аліса отримала `bg = 491` від Боба і розраховує спільний секрет `abg`. $abg = bg^a mod (n)$  $abg = 491^100 mod (997) = 247$
8. Боб отримав `ag = 390` від Аліси і розраховує спільний секерт `abg`. $abg = ag^b mod (n)$  $abg = 390^300 mod (997) = 247$
9. Причина чому це спрацювало в тому, що $(53^100)^300 mod (n) = (53^300)^100 mod (n)$, тобто $(g^a)^b = (g^b)^a$.  
