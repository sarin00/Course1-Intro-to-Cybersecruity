...
8. Натисніть ПКМ на _Turn on PowerShell Script Block Logging_ та оберіть **Edit**
9. Поставити галку біля **Enabled**
10. Опціонально можна поставити галку біля _log script invocation start/stop_
